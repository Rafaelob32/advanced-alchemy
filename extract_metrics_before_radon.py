...
cc_data  = rodar_radon(["radon", "cc",  "./advanced_alchemy", "-j"])
print("Rodando radon mi...")
mi_data  = rodar_radon(["radon", "mi",  "./advanced_alchemy", "-j"])
print("Rodando radon hal...")
hal_data = rodar_radon(["radon", "hal", "./advanced_alchemy", "-j"])
print("Rodando radon raw...")
raw_data = rodar_radon(["radon", "raw", "./advanced_alchemy", "-j"])

# Não altere o nome dessa pasta, os relatórios vão ser salvos nessa subpasta.
