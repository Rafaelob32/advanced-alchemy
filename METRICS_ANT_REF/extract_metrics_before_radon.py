...
cc_data = rodar_radon(["py", "-m", "radon", "cc", "advanced_alchemy", "-j"])

print("Rodando radon mi...")
mi_data = rodar_radon(["py", "-m", "radon", "mi", "advanced_alchemy", "-j"])

print("Rodando radon hal...")
hal_data = rodar_radon(["py", "-m", "radon", "hal", "advanced_alchemy", "-j"])

print("Rodando radon raw...")
raw_data = rodar_radon(["py", "-m", "radon", "raw", "advanced_alchemy", "-j"])
